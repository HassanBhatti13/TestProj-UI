...
export class BookServiceProxy {
     ...
     * @return OK
     */
    get(id: number | undefined): Observable<BookDto> {
        let url_ = this.baseUrl + "/api/services/app/Book/Get?";
        if (id === null)
     ...
     * @return OK
     */
    getAll(keyword: string | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<BookDtoPagedResultDto> {
     ...
     * @return OK
     */
    create(body: CreateBookDto | undefined): Observable<BookDto> {
